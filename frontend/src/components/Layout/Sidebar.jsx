...
const Sidebar = () => {
  ...
  return (
    <aside className="flex min-h-screen w-64 shrink-0 flex-col bg-[#0f172a] px-4 py-5 shadow-[4px_0_24px_rgba(0,0,0,0.12)]">
      ...
      <nav className="mt-6 flex flex-1 flex-col gap-1 overflow-y-auto pb-4" aria-label="Admin navigation">
      ...
      <div className="mt-auto border-t border-slate-800/80 pt-4">
        ...
        <p className="mt-3 px-1 text-xs text-slate-600">PSTO Calendar · Admin</p>
      </div>
    </aside>
  );
};
