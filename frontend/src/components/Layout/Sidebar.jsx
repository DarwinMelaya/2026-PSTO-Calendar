...
const OrgChartIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 6.75v2.25m0 0H8.25m3.75 0h3.75M8.25 9v2.25m7.5-2.25V9M8.25 11.25v2.25h7.5v-2.25M6 5.25h12A1.5 1.5 0 0119.5 6.75v10.5A1.5 1.5 0 0118 18.75H6A1.5 1.5 0 014.5 17.25V6.75A1.5 1.5 0 016 5.25zm-1.5 10.5h3v3h-3v-3zm9 0h3v3h-3v-3z"
    />
  </svg>
);
...
const MOBILE_MORE_LINKS = [
  ...
  { label: "Org Chart", to: "/admin-add-org-chart", Icon: OrgChartIcon },
  {
    label: "Project Timeline",
    to: "/admin-project-timeline",
    Icon: ProjectTimelineIcon,
  },
  {
...
const Sidebar = () => {
  ...
  const moreIsActive =
    moreOpen || MOBILE_MORE_LINKS.some((item) => location.pathname === item.to);
      ...
      >
        ...
        <div className="relative z-10 flex h-full w-full flex-col overflow-hidden rounded-2xl text-white">
          ...
          >
            ...
            {navFilter("Org Chart") && (
              <NavLink to="/admin-add-org-chart" className={navItemClass}>
                <OrgChartIcon />
                <span className="truncate">Org Chart</span>
              </NavLink>
            )}
