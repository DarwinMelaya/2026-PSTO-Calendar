...
const OwnerOpenTasksModal = ({ isOpen, onClose, ownerLabel, tasks }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="owner-open-tasks-modal-title"
    >
      <button
        type="button"
      ...
      <div className="relative z-10 flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
        <div className="flex items-start justify-between gap-4 border-b border-slate-100 px-6 py-5">
          <div className="min-w-0">
            <h2
              id="owner-open-tasks-modal-title"
              className="text-xl font-semibold text-slate-900"
            >
              Open tasks
            </h2>
            <p className="mt-1 truncate text-sm text-slate-500">
              {ownerLabel ?? "—"} · not completed
            </p>
          </div>
          <button
            type="button"
